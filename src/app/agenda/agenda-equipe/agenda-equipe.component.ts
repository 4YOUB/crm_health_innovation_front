...
@Component({
  selector: "ms-agenda-equipe",
  templateUrl: "./agenda-equipe.component.html",
  styleUrls: ["./agenda-equipe.component.scss"],
})
export class AgendaEquipeComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.get_app_params();
    setTimeout(() => {
      this.pageTitleService.setTitle("Rapport Agenda équipe");
    }, 0);
