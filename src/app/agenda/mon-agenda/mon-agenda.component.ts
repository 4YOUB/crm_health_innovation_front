...
@Component({
  selector: "ms-mon-agenda",
  templateUrl: "./mon-agenda.component.html",
  styleUrls: ["./mon-agenda.component.scss"],
})
export class MonAgendaComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.get_app_params();
    setTimeout(() => {
      this.pageTitleService.setTitle("Mon Agenda");
    }, 0);
  ...
  openDialogActions(clickedDate, viewType, isLimited = false): void {
    ...
    dialogRef.componentInstance.heurePasse = moment(clickedDate).isBefore(moment())
  }
